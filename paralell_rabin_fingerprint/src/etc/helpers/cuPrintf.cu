...
#define CUPRINTF_POSTAMBLE \
    ...
    return end ? (int)(end - start) : 0;
			...
			template<typename T1, typename T2, typename T3, typename T4, typename T5> __device__ int cuPrintf(const char *fmt, T1 arg1, T2 arg2, T3 arg3,
					T4 arg4, T5 arg5) {
				CUPRINTF_PREAMBLE
				;
			...
			template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> __device__ int cuPrintf(const char *fmt, T1 arg1, T2 arg2,
			...
			template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7> __device__ int cuPrintf(const char *fmt,
			...
			template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8> __device__ int cuPrintf(
			...
			template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9> __device__ int cuPrintf(
			...
			template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10> __device__ int cuPrintf(
	...
	if (magic == CUPRINTF_SM10_MAGIC) {
		...
		while (blockptr < (printfbuf_device + printfbuf_len)) {
			...
			if (hdr.offset > 0) {
				...
				if (sync_printfs)
					doPrintfDisplay(showThreadID, clearOnPrint, blockptr + CUPRINTF_MAX_LEN, blockptr + hdr.thread_buf_len,
							blockptr + hdr.offset + CUPRINTF_MAX_LEN, blockptr + hdr.thread_buf_len);
				doPrintfDisplay(showThreadID, clearOnPrint, blockptr + CUPRINTF_MAX_LEN, blockptr + hdr.thread_buf_len, blockptr + CUPRINTF_MAX_LEN,
